...
if __name__ == '__main__':
    ...
    # graph_path = "graph/results/laion400M_graph_malefemale_30000.pkl"
    # key_map_path = "graph/results/key_map_malefemale_30000.pkl.gz"
    # graph, key_map = load_graph_and_keymap(graph_path, key_map_path)
    ...
    # cls_strs = ["man", "woman"]
    # men_bias_terms = ["young", "iron", "right", "happy", "background", "people", "friday", "business", "during", "office", "4", "vector", "old", "club", "game", "leather", "vintage", "mode", "fire", "top", "shirt", "wholesale", "gloves", "cotton", "homme", "jacket", "blue", "military", "sports", "wallet", "hdmi", "royalty", "wednesday", "engineer"]
    # women_bias_terms = ["stock", "young", "free", "beautiful", "royalty", "happy", "shoes", "portrait", "shopping", "blue", "smiling", "bag", "fashion", "beach", "summer", "kitchen", "winter", "new", "vietnam", "warm", "fluff", "pony", "cocktail", "medical"]


    # for s in men_bias_terms:
    #     cls_strs.append(s)

    # for s in women_bias_terms:
    #     cls_strs.append(s)
